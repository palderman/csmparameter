...
prior_fun <- csmparameter::prm_prior_sampler_function(-Inf, Inf, 0, 1, "normal")
...
prior_fun <- csmparameter::prm_prior_sampler_function(0, Inf, 0, 1, "normal")
...
prior_fun <- csmparameter::prm_prior_sampler_function(-Inf, 0, 0, 1, "normal")
...
prior_fun <- csmparameter::prm_prior_sampler_function(0, NA, 0, 1, "normal")
...
prior_fun <- csmparameter::prm_prior_sampler_function(0, NULL, 0, 1, "normal")
...
prior_fun <- csmparameter::prm_prior_sampler_function(NULL, 0, 0, 1, "normal")
...
prior_fun <- csmparameter::prm_prior_sampler_function(pmin, pmax, pmu, psigma, "normal")
...
prior_fun <- csmparameter::prm_prior_sampler_function(pmin, pmax, pmu, psigma, "uniform")
